...
function Rating({ rate, onChange }) {
    ...
    return (
        <div style={{ display: "flex" }}>
            <Star active={star >= 1} onClick={() => setStar(1)} />
            <Star active={star >= 2} onClick={() => setStar(2)} />
            <Star active={star >= 3} onClick={() => setStar(3)} />
            <Star active={star >= 4} onClick={() => setStar(4)} />
            <Star active={star >= 5} onClick={() => setStar(5)} />
        </div>
    );
}
